	...
	return function a(b, c, d) {
		...
		6: [function(a, b, c) {
			...
			b.exports = function() {
				...
				function b() {
					return a.xv = c, a.yv = d, a
				}
				var c = function(b, c) {
						return arguments.length < 2 ? b.x : (b.x = c, a)
					},
					d = function(b, c) {
						return arguments.length < 2 ? b.y : (b.y = c, a)
					};
		...
		20: [function(a, b, c) {
			...
			b.exports = function(a, b, c, e) {
				return function() {
					function f(b) {
						var c = e().accessor(f.accessor()).period(g.period).init(),
							h = e().accessor(f.accessor()).period(g.period).init(),
							i = e().accessor(f.accessor()).period(g.period).init(),
							j = e().accessor(f.accessor()).period(g.period).init();
						return b.map(function(e, f) {
							if (f < 1) return d(g.accessor.d(e));
							var k = g.accessor.h(b[f]) - g.accessor.h(b[f - 1]),
								l = g.accessor.l(b[f - 1]) - g.accessor.l(b[f]),
								m = 0;
							k > l && k > 0 && (m = k);
							var n = 0;
							l > k && l > 0 && (n = l);
							var o = a([g.accessor.h(e) - g.accessor.l(e), Math.abs(g.accessor.h(e) - g.accessor.c(b[f - 1])), Math.abs(g.accessor.l(e) - g.accessor.c(b[f - 1]))]),
								p = c.average(m),
								q = h.average(n),
								r = i.average(o);
							if (f > g.period) {
								...
								return f >= 2 * g.period ? d(g.accessor.d(e), v, s, t) : d(g.accessor.d(e))
							}
					...
					var g = {};
					return b(f, g).accessor(c()).period(14), f
				}
			}
		}, {}],
		21: [function(a, b, c) {
				...
				return function() {
					function c(a) {
						return a.map(function(b, c) {
							if (c >= e.period - 1) {
								for (var i = 0, j = 0, k = 1e4, l = 0, m = 0; m < e.period; m++) e.accessor.h(a[c - m]) > i && (i = e.accessor.h(a[c - m]), j = m), e.accessor.l(a[c - m]) < k && (k = e.accessor.l(a[c - m]), l = m);
								var n = (e.period - j) / e.period * 100,
									o = (e.period - l) / e.period * 100,
									p = n - o;
								return d(e.accessor.d(b), n, o, p, g, f, h)
							}
		...
		24: [function(a, b, c) {
			...
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b, i = c().accessor(e.accessor()).period(g.period).init();
						return a.map(function(c, e) {
							var j = i.average(g.accessor(c));
							if (e >= g.period) {
								var k = 0;
								for (b = 0; b < g.period; b++) k += Math.pow(g.accessor.c(a[e - b]) - j, 2);
								f = Math.sqrt(k / g.period);
								var l = j + h * f,
									m = j - h * f;
								return d(g.accessor.d(c), j, l, m)
							}
					...
					var f, g = {},
						h = 2;
					return e.sdMultiplication = function(a) {
						return arguments.length ? (h = a, e) : h
					}, a(e, g).accessor(b()).period(20), e
				}
			}
		}, {}],
		25: [function(a, b, c) {
				...
				return function() {
					function e(a) {
						...
						return a.map(function(a) {
							...
							return e.high = d([e.open, e.close, f.accessor.h(a)]), e.low = c([e.open, e.close, f.accessor.l(a)]), void 0 !== f.accessor.v && void 0 !== f.accessor.v(a) && (e.volume = f.accessor.v(a)), b = e
						})
					}
					var f = {};
					return a(e, f).accessor(b()), e
				}
			}
		}, {}],
		27: [function(a, b, c) {
		...
		28: [function(a, b, c) {
			...
			b.exports = function(b) {
				...
				return {
					...
					roc: l(k, c, f.ohlc, h, 1),
					sroc: l(k, c, f.ohlc, h, 13),
		...
		29: [function(a, b, c) {
			...
			b.exports = function() {
				return function(a, b) {
					...
					}, c.preroll = function(b) {
						return a.preroll = b, c
					}, a.preroll = function() {
						return 0
					}, c
				}
		...
		30: [function(a, b, c) {
			...
			b.exports = function(a, b, c) {
				return function() {
					...
					}, a(e, f).accessor(b()).preroll(e.slow), e
				}
			}
		}, {}],
		31: [function(a, b, c) {
				...
				return function() {
					function e(a) {
						return j.accessor(e.accessor()).period(f.period).init(), k.accessor(e.accessor()).period(f.period).init(), a.map(function(b, c) {
							if (c < 1) return d(f.accessor.d(b));
		...
		33: [function(a, b, c) {
			...
			b.exports = function(a, b, c, d, e) {
				return function() {
					function f(a) {
						return f.init(), a.map(g).filter(function(a) {
							return null !== a.value
						})
					}

					function g(a, b) {
						var c = f.roc(i.accessor(a));
						return (!h.primed() || b + 1 < j.period()) && (c = null), {
							date: i.accessor.d(a),
							value: c
						}
					}
					...
					return f.init = function() {
						return j.init(), h = a(i.period), f
					}, f.roc = function(a) {
						return h.push(j.average(a)), (h.head() - h.last()) / h.last()
					}, f.ema = function(a) {
						return arguments.length ? (j = a, f) : j
					}, b(f, i).accessor(c()).period(21), f
				}
			}
		}, {}],
		34: [function(a, b, c) {
			...
			b.exports = function(a, b) {
				return function() {
					function c(a) {
						var b = c.preroll();
						return a.map(function(c, j) {
							if (j >= b) {
								for (var k = [], l = [], m = [], n = 0; n < f; n++) k.push(0), l.push(1e4), m.push(0);
								for (var o = 0, p = 0; p < f; p++) {
									for (var q = 0; q < e.period; q++) e.accessor.h(a[j - q - p]) > k[p] && (k[p] = e.accessor.h(a[j - q - p])), e.accessor.l(a[j - q - p]) < l[p] && (l[p] = e.accessor.l(a[j - q - p]));
									var r = k[p] - l[p];
									r > 0 ? m[p] = (e.accessor.c(a[j - p]) - l[p]) / (k[p] - l[p]) * 100 : m[p] = 50, o += m[p]
								}
								var s = m[0];
								return o /= f, d(e.accessor.d(c), s, o, h, g, i)
							}
							return d(e.accessor.d(c), null, null, h, g, i)
						}).filter(function(a) {
							return a.stochasticK
						})
					}
					...
					return c.periodD = function(a) {
						...
						return arguments.length ? (i = a, c) : i
					}, a(c, e).accessor(b()).period(20).preroll(function() {
						return e.period + f
					}), c
				}
			}
				...
				return function() {
					function c(a) {
						return a.map(function(b, c) {
							if (c >= e.period) {
								for (var i = 0, j = 0, k = 1e4, l = 0, m = 0; m < e.period; m++) e.accessor.h(a[c - m]) > i && (i = e.accessor.h(a[c - m]), j = m), e.accessor.l(a[c - m]) < k && (k = e.accessor.l(a[c - m]), l = m);
								var n = (e.accessor.c(a[c]) - k) / (i - k) * 100;
								return d(e.accessor.d(b), n, g, f, h)
							}
							return d(e.accessor.d(b))
						}).filter(function(a) {
							return a.williams
		...
		37: [function(a, b, c) {
			...
			function d(a, b, c, d) {
				a.select("path.adx").attr("d", b), a.select("path.plusDi").attr("d", c), a.select("path.minusDi").attr("d", d)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b = g.dataSelector(a);
						b.entry.append("path").attr("class", "adx"), b.entry.append("path").attr("class", "plusDi"), b.entry.append("path").attr("class", "minusDi"), e.refresh(a)
					}
					...
					}, c(e, g).plot(a(), f).dataSelector(c.dataMapper.array), f(), e
				}
			}
		}, {}],
		38: [function(a, b, c) {
			...
			function d(a, b, c, d, e, f, g, h, i, j) {
				a.select("path.overbought").attr("d", e.horizontalPathLine(b.d, c, b.ob, d)), a.select("path.oversold").attr("d", e.horizontalPathLine(b.d, c, b.os, d)), a.select("path.aroon.oscillator").attr("d", f), a.select("path.aroon.oscillatorArea").attr("d", g), a.select("path.aroon.middle").attr("d", h), a.select("path.aroon.up").attr("d", i), a.select("path.aroon.down").attr("d", j)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
		...
		39: [function(a, b, c) {
			...
			function d(a, b, c) {
				a.select("path.up").attr("d", b), a.select("path.down").attr("d", c)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b = g.dataSelector(a);
						b.entry.append("path").attr("class", "up"), b.entry.append("path").attr("class", "down"), e.refresh(a)
					}
		...
		40: [function(a, b, c) {
			...
			function d(a, b, c, d, e, g, j, k, l) {
				...
				a.attr("transform", "translate(" + l[0] + "," + l[1] + ")"), a.select("path").attr("d", i(b, c, d, g, j, k, m)), a.select("text").text(h(b, e)).call(f, b, c, d, m)
			}
			...
			function e(a, b) {
				return function(c) {
					var d = b.range(),
						e = d[0],
						f = d[d.length - 1];
					return d = e < f ? [e, f] : [f, e], c.filter(function(c) {
						if (null === a(c) || void 0 === a(c)) return !1;
						var e = b(a(c));
			...
			function i(a, b, c, d, e, f, g) {
				return function(h) {
					...
					switch (c) {
						...
						case "right":
							var l = 0;
							return d / 2 < f ? k = d / 2 : l = d / 2 - f, "M 0 " + j + " l " + g * Math.max(b.tickSizeInner(), 1) + " " + -k + " l 0 " + -l + " l " + g * e + " 0 l 0 " + d + " l " + g * -e + " 0 l 0 " + -l;
						case "top":
						case "bottom":
							var m = 0;
							return e / 2 < f ? k = e / 2 : m = e / 2 - f, "M " + j + " 0 l " + -k + " " + g * Math.max(b.tickSizeInner(), 1) + " l " + -m + " 0 l 0 " + g * d + " l " + e + " 0 l 0 " + g * -d + " l " + -m + " 0";
						default:
			...
			b.exports = function(a, b, c, f, g) {
				return function() {
					function f(a) {
						...
						b.entry.append("path"), b.entry.append("text"), f.refresh(a)
					}
					var h, i = {},
						j = a(b()),
						k = 4,
					...
					}, g(f, i).accessor(c()).dataSelector(), f
				}
			}
		}, {}],
		41: [function(a, b, c) {
			...
			function d(a, b, c, d) {
				a.select("path.upper").attr("d", b), a.select("path.middle").attr("d", c), a.select("path.lower").attr("d", d)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b = g.dataSelector(a);
						b.entry.append("path").attr("class", "upper"), b.entry.append("path").attr("class", "middle"), b.entry.append("path").attr("class", "lower"), e.refresh(a)
					}
		...
		42: [function(a, b, c) {
			...
			b.exports = function(a, b, c, d, e) {
				return function() {
					...
					function b() {
						h = d.joinPath(f), i = d.joinPath(g), j = d.scaledStrokeWidth(k.xScale, 1, 4)
					}
					...
					function f() {
						...
						return function(e) {
							var f = c(a.o(e)),
								...
								h = b(a.d(e)) - d / 2,
								i = "M " + h + " " + f + " l " + d + " 0";
							return f != g && (i += " L " + (h + d) + " " + g + " l " + -d + " 0 L " + h + " " + f), i
						}
					}
					...
					function g() {
						...
						return function(e) {
							...
							return f == g && (j += " M " + i + " " + f + " l " + d + " 0"), j + " M " + h + " " + Math.max(f, g) + " L " + h + " " + c(a.l(e))
						}
					}
					var h, i, j, k = {};
					...
					}, e(a, k).plot(c(), b).width(b).dataSelector(e.dataMapper.array), b(), a
				}
			}
		}, {}],
		43: [function(a, b, c) {
			...
			b.exports = function(a, b, c, d, e, f, g) {
				return function() {
					function a(b) {
						...
						c.entry.append("path").attr("class", "horizontal wire"), c.entry.append("path").attr("class", "vertical wire"), c.entry.append("g").attr("class", "axisannotation x").call(u), c.entry.append("g").attr("class", "axisannotation y").call(v), b.selectAll("rect").data([void 0]).enter().append("rect").style("fill", "none").style("pointer-events", "all"), a.refresh(b)
					}

					function b(a, b, d, e, f) {
						return function() {
							a.node().__coord__ = c(this), h(a, b, d, e, f)
						}
					}
					...
					function h(a, b, c, d, e) {
						...
						if (void 0 !== f) {
							...
							s.accessor.xv(g, h), s.accessor.yv(g, i), j && t.call("move", a.node(), g)
						}
						b.attr("d", o), c.attr("d", p), d.call(u.refresh), e.call(v.refresh), a.attr("display", n)
					}

					function i() {
						return u.accessor(s.accessor.xv).scale(s.xScale), v.accessor(s.accessor.yv).scale(s.yScale), a
					}

					function j() {
						var a = r || s.xScale.range();
						return function(b) {
							if (null === s.accessor.yv(b)) return null;
					...
					function k() {
						...
						return function(b) {
							if (null === s.accessor.xv(b)) return null;
					...
					function l(a) {
						return a = a || {}, s.accessor.xv(a, null),
							s.accessor.yv(a, null), a
					}
					...
					var o, p, q, r, s = {},
						t = d("enter", "out", "move"),
						u = f.plotComposer().scope("composed-annotation").plotScale(function(a) {
							return a.axis().scale()
						}),
					...
					return a.refresh = function(a) {
						var c = s.xScale.range(),
							...
							m = e.select("g.axisannotation.y");
						o = k(), p = j(), a.selectAll("rect").attr("x", Math.min.apply(null, c)).attr("y", Math.min.apply(null, d)).attr("height", Math.abs(d[d.length - 1] - d[0])).attr("width", Math.abs(c[c.length - 1] - c[0])).on("mouseenter", function() {
							t.call("enter", this)
						}).on("mouseout", function() {
							t.call("out", this), delete e.node().__coord__, l(e.datum()), h(e, f, g, i, m)
						}).on("mousemove", b(e, f, g, i, m)), h(e, f, g, i, m)
					}, a.xAnnotation = function(a) {
						return arguments.length ? (u.plots(a instanceof Array ? a : [a]), i()) : u.plots()
					}, a.yAnnotation = function(a) {
						return arguments.length ? (v.plots(a instanceof Array ? a : [a]), i()) : v.plots()
						...
						return m(a) ? [l()] : [a]
					}).on(t), s.dataSelector.scope("crosshair"), i()
				}
			}
		}, {}],
		44: [function(a, b, c) {
				...
				return function() {
					function h(a) {
						var b = m.dataSelector(a),
							c = "kumoclipup-" + e(),
							d = "kumoclipdown-" + e();
						b.entry.append("clipPath").attr("id", d).attr("class", "kumoclipdown").append("path"), b.entry.append("clipPath").attr("id", c).attr("class", "kumoclipup").append("path"), b.entry.append("path").attr("class", "kumo down").attr("clip-path", "url(#" + d + ")"), b.entry.append("path").attr("class", "kumo up").attr("clip-path", "url(#" + c + ")"), b.entry.append("path").attr("class", "senkouspanb"), b.entry.append("path").attr("class", "senkouspana"), b.entry.append("path").attr("class", "chikouspan"), b.entry.append("path").attr("class", "kijunsen"), b.entry.append("path").attr("class", "tenkansen"), h.refresh(a)
					}

					function i(a, b) {
						a.select(".kumoclipdown path").attr("d", n.y1(b.range()[0])), a.select(".kumoclipup path").attr("d", n.y1(b.range()[1])), a.select("path.kumo.down").attr("d", o), a.select("path.kumo.up").attr("d", o), a.select("path.senkouspanb").attr("d", q), a.select("path.senkouspana").attr("d", p), a.select("path.chikouspan").attr("d", r), a.select("path.kijunsen").attr("d", t), a.select("path.tenkansen").attr("d", s)
					}

					function j() {
						p.init(m.accessor.d, m.xScale, m.accessor.sa, m.yScale, m.accessor.pks), q.init(m.accessor.d, m.xScale, m.accessor.sb, m.yScale, m.accessor.pks), r.init(m.accessor.d, m.xScale, m.accessor.c, m.yScale, d(m.accessor.pks)), s.init(m.accessor.d, m.xScale, m.accessor.ts, m.yScale), t.init(m.accessor.d, m.xScale, m.accessor.ks, m.yScale)
					}
					...
					}, g(h, m).plot(c(), j).dataSelector(g.dataMapper.array), j(), h
				}
			}
		}, {}],
		45: [function(a, b, c) {
		...
		46: [function(a, b, c) {
			...
			function d(a, b, c, d, e, f, g) {
				a.select("path.line").attr("d", f), g && a.select("path.zero").attr("d", e.horizontalPathLine(b.d, c, b.z, d))
			}
			b.exports = function(a, b, c, e) {
				return e = e || !1,
					function() {
						function f(a) {
							...
							b.entry.append("path").attr("class", "line"), e && b.selection.append("path").attr("class", "zero"), f.refresh(a)
						}
						...
						}, c(f, h).plot(a(), g).dataSelector(c.dataMapper.array), g(), f
					}
			}
		}, {}],
		47: [function(a, b, c) {
			...
			function d(a, b, c, d, e, f, g, h) {
				a.select("path.difference").attr("d", f), a.select("path.zero").attr("d", e.horizontalPathLine(b.d, c, b.z, d)), a.select("path.macd").attr("d", g), a.select("path.signal").attr("d", h)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b = i.dataSelector(a);
						b.selection.append("path").attr("class", "difference"), b.selection.append("path").attr("class", "zero"), b.selection.append("path").attr("class", "macd"), b.selection.append("path").attr("class", "signal"), e.refresh(a)
					}
					...
					}, c(e, i).plot(a(), f).width(f).dataSelector(c.dataMapper.array), f(), e
				}
			}
		}, {}],
		48: [function(a, b, c) {
			...
			b.exports = function(a, b, c, d, e) {
				return function() {
					function a(b) {
						d.appendPathsUpDownEqual(i.dataSelector(b).selection, i.accessor, "ohlc"), a.refresh(b)
					}

					function b() {
						g = d.joinPath(f), h = d.scaledStrokeWidth(i.xScale, 1, 2)
					}
					...
					}, e(a, i).plot(c(), b).width(b).dataSelector(e.dataMapper.array), b(), a
				}
			}
		}, {}],
		49: [function(a, b, c) {
			...
			b.exports = function(a, b, c, d) {
				...
				function l(a, b) {
					if (a.length) {
						for (var c = a[0], d = 1; d < a.length; d++) c += b + a[d];
						return c
					}
				}
				...
				function m() {
					...
					return a.refresh = function(a) {
						e.select(a).data(function(a) {
							var d = c(a);
							if (null === d || void 0 === d) return f.map(function() {
								return []
							});
							var e = b(d);
						...
						return arguments.length ? (e.scope(b), a) : e.scope()
				...
				var n = function(a) {
					...
					return b.select = function(a) {
						...
						return arguments.length ? (d = a, e = ["data", "scope-" + d], b) : d
					}, b.key = function(a) {
						return arguments.length ? (c = a, b) : c
					}, b
				};
					...
					interaction: {
						mousedispatch: function(a) {
							return function(b) {
								return b.on("mouseenter", function(b) {
									d(this.parentNode).classed("mouseover", !0), a.call("mouseenter", this, b)
								}).on("mouseleave", function(b) {
									var c = d(this.parentNode);
									c.classed("dragging") || (c.classed("mouseover", !1), a.call("mouseout", this, b))
						...
						dragStartEndDispatch: function(a, b) {
							return a.on("start", function(a) {
								d(this.parentNode.parentNode).classed("dragging", !0), b.call("dragstart", this, a)
							}).on("end", function(a) {
								d(this.parentNode.parentNode).classed("dragging", !1), b.call("dragend", this, a)
							})
						}
					},
					plotComposer: m
			...
			b.exports = function(a, b, c, d, e) {
				var f = function(f, g) {
					...
					return h.dataSelector = function(a, b) {
						return g.dataSelector = d(a).key(b), h
					}, h.xScale = function(a) {
						return g.xScale = c(), f.xScale = function(b) {
							return arguments.length ? (g.xScale = b, a && a(), f) : g.xScale
						}, h
					}, h.yScale = function(b) {
						return g.yScale = a(), f.yScale = function(a) {
							return arguments.length ? (g.yScale = a, b && b(), f) : g.yScale
						}, h
					}, h.accessor = function(a, b) {
						return g.accessor = a, f.accessor = function(a) {
							return arguments.length ? (g.accessor = a, b && b(), f) : g.accessor
						}, h
					}, h.width = function(a) {
						return g.width = e, f.width = function(c) {
							return arguments.length ? (g.width = b(c), a && a(), f) : g.width
						}, h
					}, h.on = function(a, b) {
						return f.on = function(c, d) {
							return a.on(c, d), b && b(), f
						}, h
					}, h.plot = function(a, b) {
						return h.xScale(b).yScale(b).accessor(a, b)
					}, h
				};
				return f.dataMapper = d.mapper, f
			}
		}, {}],
		51: [function(a, b, c) {
			"use strict";
			...
			function d(a, b, c, d, e, f) {
				a.select("path.overbought").attr("d", e.horizontalPathLine(b.d, c, b.ob, d)), a.select("path.middle").attr("d", e.horizontalPathLine(b.d, c, b.m, d)), a.select("path.oversold").attr("d", e.horizontalPathLine(b.d, c, b.os, d)), a.select("path.rsi").attr("d", f)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b = g.dataSelector(a);
						b.entry.append("path").attr("class", "overbought"), b.entry.append("path").attr("class", "middle"), b.entry.append("path").attr("class", "oversold"), b.entry.append("path").attr("class", "rsi"), e.refresh(a)
					}
		...
		52: [function(a, b, c) {
			...
			function d(a, b, c, d, e, f, g) {
				a.select("path.overbought").attr("d", e.horizontalPathLine(b.d, c, b.ob, d)), a.select("path.oversold").attr("d", e.horizontalPathLine(b.d, c, b.os, d)), a.select("path.stochastic.up").attr("d", f), a.select("path.stochastic.down").attr("d", g)
			}
			b.exports = function(a, b, c) {
				return function() {
					function e(a) {
						var b = g.dataSelector(a);
						b.entry.append("path").attr("class", "overbought"), b.entry.append("path").attr("class", "oversold"), b.entry.append("path").attr("class", "stochastic up"), b.entry.append("path").attr("class", "stochastic down"), e.refresh(a)
					}
		...
		53: [function(a, b, c) {
			...
			function d(a, b, c, d, f) {
				a.select(".supstance path").attr("d", e(b, c, d)), a.select(".interaction path").attr("d", e(b, c, d)), a.select(".axisannotation.y").call(f.refresh)
			}

			function e(a, b, c) {
				return function(d) {
					var e;
					return f(a) ? (e = [a.s(d), a.e(d)], e[0] = void 0 !== e[0] ? b(e[0]) : b.range()[0], e[1] = void 0 !== e[1] ? b(e[1]) : b.range()[1]) : e = b.range(), "M " + e[0] + " " + c(a(d)) + " L " + e[e.length - 1] + " " + c(a(d))
				}
			}
			...
			b.exports = function(a, b, c, e, f, g, h) {
				function i() {
					function a(b) {
						...
						d.entry.append("g").attr("class", "supstance").append("path"), d.entry.append("g").attr("class", "axisannotation y").call(k);
						var e = d.entry.append("g").attr("class", "interaction").style("opacity", 0).style("fill", "none").call(g.interaction.mousedispatch(i));
						e.append("path").style("stroke-width", "16px"), a.refresh(b)
					}

					function b() {
						return k.accessor(c.accessor.v).scale(c.yScale), a
					}
					var c = {},
					...
					return a.refresh = function(a) {
						...
						return arguments.length ? (k.plots(b instanceof Array ? b : [b]), a) : k.plots()
					}, h(a, c).dataSelector(h.dataMapper.unity).plot(f(), b).on(i), c.dataSelector.scope("supstance"), b()
				}
				...
				function j(e, f, h, i, j) {
					var k = a().subject(function(a) {
						...
						f.v(a, g), d(k, f, h, i, j), e.call("drag", this, a)
					});
		...
		54: [function(a, b, c) {
			...
			b.exports = function(a, b, c, d, e) {
				return function() {
					function a(b) {
						i.dataSelector(b).entry.append("path").attr("class", "tick"), a.refresh(b)
					}
				...
				return function() {
					function j(b) {
						var e = o.dataSelector(b),
							f = m(b.datum());
						g.appendPathsGroupBy(e.selection, o.accessor, "tradearrow", f), e.entry.append("path").attr("class", "highlight").style("pointer-events", "none"), e.selection.selectAll("path.tradearrow").on("mouseenter", function(b) {
							var e = l(b, c(this)[0]);
							a(this.parentNode).select("path.highlight").datum(e.d).attr("d", r).call(d, f), p.call("mouseenter", this, e.d, e.i)
					...
					return j.refresh = function(a) {
						...
						return arguments.length ? (r.orient(a), k()) : r.orient()
					}, j.y = function(a) {
						return arguments.length ? (q = b(a), k()) : q
					}, j.arrow = function() {
						return r
					}, h(j, o).plot(f(), k).on(p).dataSelector(h.dataMapper.array), k(), j
				}
			}
		}, {}],
		56: [function(a, b, c) {
			...
			function d(a, b, c, d) {
				a.selectAll("path.body").attr("d", e(b, c, d)), a.selectAll("circle.start").attr("cx", f(b.sd, c)).attr("cy", g(b.sv, d)), a.selectAll("circle.end").attr("cx", f(b.ed, c)).attr("cy", g(b.ev, d))
			}
			...
			b.exports = function(a, b, c, e, f, g, h) {
				function i() {
					function a(d) {
						...
						f.append("path").attr("class", "body"), f.append("circle").attr("class", "start").attr("r", 1), f.append("circle").attr("class", "end").attr("r", 1);
						var h = e.entry.append("g").attr("class", "interaction").style("opacity", 0).style("fill", "none").call(g.interaction.mousedispatch(c));
						h.append("path").attr("class", "body").style("stroke-width", "16px"), h.append("circle").attr("class", "start").attr("r", 8), h.append("circle").attr("class", "end").attr("r", 8), a.refresh(d)
					}
					var b = {},
					...
					}, h(a, b).dataSelector(h.dataMapper.unity).plot(f()).on(c), a
				}
				...
				function j(e, f, h, i, j, k) {
					...
					return m.subject(function(a) {
						...
						l(h, i, b().x, j, k, b().y, a), d(c(this.parentNode.parentNode.parentNode), f, i, k), e.call("drag", this, a)
				...
				function k(e, f, h, i) {
					...
					return k.subject(function(a) {
						...
						l(f.sd, h, b().x + j.start.date, f.sv, i, b().y + j.start.value, a), l(f.ed, h, b().x + j.end.date, f.ev, i, b().y + j.end.value, a), d(c(this.parentNode.parentNode.parentNode), f, h, i), e.call("drag", this, a)
					}), g.interaction.dragStartEndDispatch(k, e)
				}

				function l(a, b, c, d, e, f, g) {
					var h = b.invert(c);
					null !== h && void 0 !== h && a(g, h), d(g, e.invert(f))
				}
				return i
			}
		}, {}],
			...
			b.exports = function(a, b, c) {
				return function() {
					function d(a) {
						...
						f() ? b.appendPathsUpDownEqual(c.selection, i.accessor, "volume") : c.entry.append("path").attr("class", "volume"), d.refresh(a)
					}
					...
					}, c(d, i).plot(a(), e).width(e).dataSelector(c.dataMapper.array), e(), d
				}
			}
		}, {}],
		58: [function(a, b, c) {
			...
			b.exports = function(a, b, c) {
				return function() {
					function d(a) {
						f.dataSelector(a).entry.append("path").attr("class", "williams up"), d.refresh(a)
					}
					...
					}, c(d, f).plot(a(), e).dataSelector(c.dataMapper.array), e(), d
				}
			}
		}, {}],
		59: [function(a, b, c) {
			...
			b.exports = function(a, b, c, e, f, g) {
				function h(b, d, n, r, s, t, u, v, w) {
					function x(a, b) {
						...
						return b = b || 0, void 0 === d && (d = r[0] > a ? -1 : c(r, a)), n(d + b)
					}
					...
					function A() {
						return z(), n.domain([0, r.length - 1]), y(), n.domain(n.range().map(f(t, E)).map(n.invert)), u.domain = n.domain(), y()
					}
					...
					var C, D = {
						...
						E = 3;
					return n = n || a(), r = r || [new Date(0), new Date(1)], s = void 0 === s ? .2 : s, t = void 0 === t ? .65 : t, u = u || {
						domain: n.domain()
					}, v = v || !1, w = w || g(n, y, u), x.invert = function(a) {
						...
						return h(b, d, n.copy(), r, s, t, u, v)
					}, x.band = function() {
						return E
					}, x.outerPadding = function(a) {
						return arguments.length ? (t = a, A()) : t
					}, x.padding = function(a) {
						return arguments.length ? (s = a, A()) : s
					}, x.zoomable = function() {
						return w
						...
						D.tickFormat = e ? e[2] : B(c, d, 10)[2], e && (a = e[0], b = e[1]);
		...
		60: [function(a, b, c) {
			...
			function e(a, b, c, e) {
				return a.scaleLinear().domain(d(a, b, c, e))
			}
			...
			b.exports = function(b) {
				function c(a, c) {
					return c = c || j.ohlc(), b.scaleLinear().domain([b.min(a.map(c.low())), b.max(a.map(c.high()))].map(f(.02)))
				}
				...
				var h = a("./zoomable")(),
					i = a("../util")(),
					j = a("../accessor")(),
					k = a("./financetime")(b.scaleLinear, b, b.bisect, i.rebindCallback, f, h);
				return {
					financetime: k,
					plot: {
						adx: function() {
							return b.scaleLinear().domain([0, 100])
						},
						aroon: function() {
							return b.scaleLinear().domain([-100, 100])
						},
						atr: d,
						atrtrailingstop: function(a, c) {
							c = c || j.atrtrailingstop();
							var d = g(a, function(a) {
								return [c.up(a), c.dn(a)]
							});
							return b.scaleLinear().domain(b.extent(d).map(f(.04)))
						},
						bollinger: function(a, c) {
							return c = c || j.bollinger(), b.scaleLinear().domain([b.min(a.map(function(a) {
								return c.lower(a)
						...
						ichimoku: function(a, c) {
							...
							return b.scaleLinear().domain(b.extent(d).map(f(.02)))
						},
						macd: function(a, c) {
							return c = c || j.macd(), e(b, a, c, .02)
						},
						momentum: d,
						moneyflow: d,
						ohlc: c,
						...
						supstance: function(a, c) {
							return c = c || j.supstance(), e(b, a, c.v, .02)
						},
						tick: c,
						time: function(a, b) {
							return b = b || j.value(), k().domain(a.map(b.d))
						},
						tradearrow: function(a, c) {
							return c = c || j.trade(), e(b, a, c.p, .02)
						},
						trendline: function(a, c) {
							c = c || j.trendline();
							var d = g(a, function(a) {
								return [c.sv(a), c.ev(a)]
							});
							return b.scaleLinear().domain(b.extent(d).map(f(.04)))
						},
						volume: function(a, c) {
							return c = c || j.ohlc().v, b.scaleLinear().domain([0, 1.15 * b.max(a.map(c))])
						},
						vwap: d,
						wilderma: d,
						williams: function() {
		...
		61: [function(a, b, c) {
			...
			b.exports = function() {
				function a(b, c, d, e) {
					...
					return e = void 0 === e || e, f.invert = b.invert, f.domain = function(a) {
						return arguments.length ? (e ? b.domain([Math.max(d.domain[0], a[0]), Math.min(d.domain[1], a[1])]) : b.domain(a), c && c(), f) : b.domain()
					}, f.range = function(a) {
				...
				return function() {
					function b(a, b) {
						...
						switch (i = "M " + j + " " + k, n) {
							case "up":
							case "down":
								i += " l " + -r + " " + p * s + " l " + q + " 0", o && (i += " l 0 " + p * s), i += " l " + q + " 0", o && (i += " l 0 " + -p * s), i += " l " + q + " 0";
								break;
							case "left":
							case "right":
								i += " l " + p * s + " " + -r + " l 0 " + q, o && (i += " l " + p * s + " 0"), i += " l 0 " + q, o && (i += " l " + -p * s + " 0"), i += " l 0 " + q;
								break;
							default:
		...
		64: [function(a, b, c) {
			"use strict";
			var d;
			if ("undefined" != typeof window) d = window.d3;
			else {
		...
		65: [function(a, b, c) {
			...
			b.exports = function a(b) {
				var c = [],
					d = b - 1;
				return a.push = function(a) {
					d = ++d % b, c.length < b ? c.push(a) : c[d] = a
				}, a.get = function(a) {
					return c[(d + c.length - a) % c.length]
				}, a.head = function() {
					return a.get(0)
				}, a.last = function() {
					return a.get(c.length - 1)
				}, a.size = function() {
					return b
				}, a.samples = function() {
					return c
		...
		66: [function(a, b, c) {
			...
			b.exports = function() {
				return {
					circularbuffer: a("./circularbuffer"),
					rebindCallback: d,
					rebind: function(a, b) {

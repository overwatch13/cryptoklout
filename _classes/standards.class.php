...
class Standards {
	// *****************************  LOCAL DATABASE ACCESS   *************************************************
		...
		protected $host = 'crypto_db';
		protected $host_user = 'crypto_local'; // 'cryptokl_user2';
		protected $host_pw = 'password'; //'F%hd&F36*cnhJt';
		protected $database = 'cryptokl_local'; // 'cryptokl_main';
